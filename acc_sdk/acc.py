...
from .data_connector import AccDataConnectorApi
...
class Acc:
    ...
    def __init__(self, auth_client: Authentication, account_id=None):
        """
        ...
        self.data_connector = AccDataConnectorApi(self.base)
    ...
    def get_forms(self, project_id, **forms_kwargs) -> list[dict]:
        ...
        project_users = self.project_users.get_users(
            project_id,
            query_params={
                "filter['autodeskId']": user_names,
                "fields": ["email", "name", "autodeskId"],
            },
        )
